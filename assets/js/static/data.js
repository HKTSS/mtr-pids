class Route {
    ...
    stations;
    hidden;
    constructor(initials, name, color, secondaryColor, isLRT, directionInfo, stations, hidden) {
...
const RouteList = {
    ...
    'TKL': new Route('TKL', '將軍澳綫|Tsueng Kwan O Line', '#7d499d', '#7d499d', false, ["POA", "NOP"], ["NOP", "QUB", "YAT", "TIK", "TKO", "LHP", "HAH", "POA"]),
    
    'TCL': new Route('TCL', '東涌綫|Tung Chung Line', '#f7943e', '#f7943e', false, ["TUC", "HOK"], ["HOK", "KOW", "OLY", "NAC", "LAK", "TSY", "SUN", "TUC"]),
    'AEL': new Route('AEL', '機場快綫|Airport Express', '#00888a', '#00888a', false, ["AWE", "HOK"], ["HOK", "KOW", "TSY", "AIR", "AWE"]),
    
    'TML': new Route('TML', '屯馬綫|Tuen Ma Line', '#923011', '#923011', false, ["TUM", "WKS"], ["TUM", "SIH", "TIS", "LOP", "YUL", "KSR", "TWW", "MEF", "NAC", "AUS", "ETS", "HUH", "HOM", "TKW", "SUW", "KAT", "DIH", "HIK", "TAW", "CKT", "STW", "CIO", "SHM", "TSH", "HEO", "MOS", "WKS"]),
    'EAL': new Route('EAL', '東鐵綫|East Rail Line', '#53b7e8', '#53b7e8', false, ["LOW", "ADM"], ["ADM", "EXC", "HUH", "MKK", "KOT", "TAW", "SHT", "RAC", "FOT", "UNI", "TAP", "TWO", "FAN", "SHS", "LOW", "LMC"]),
    
    'SIL': new Route('SIL', '南港島綫|South Island Line', '#bac429', '#bac429', false, ["SOH", "ADM"], ["ADM", "OCP", "WCH", "LET", "SOH"]),
    
    'DRL': new Route('DRL', '迪士尼綫|Disneyland Resorts Line', '#f173ac', '#f173ac', false, ["SUN", "DIS"], ["SUN", "DIS"]),
    
    'LRT': new Route('LRT', '輕鐵|Light Rail', '#d3a809', '#d3a809', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], false),
    'LR505': new Route('505', '輕鐵 505|Light Rail 505', '#d3a809', '#da2128', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR507': new Route('507', '輕鐵 507|Light Rail 507', '#d3a809', '#00a650', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR610': new Route('610', '輕鐵 610|Light Rail 610', '#d3a809', '#551b14', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR614': new Route('614', '輕鐵 614|Light Rail 614', '#d3a809', '#00c0f3', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR614P': new Route('614P', '輕鐵 614P|Light Rail 614P', '#d3a809', '#f4858d', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR615': new Route('615', '輕鐵 615|Light Rail 615', '#d3a809', '#ffdd00', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR615P': new Route('615P', '輕鐵 615P|Light Rail 615P', '#d3a809', '#006684', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR705': new Route('705', '輕鐵 705|Light Rail 705', '#d3a809', '#9acd32', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR706': new Route('706', '輕鐵 706|Light Rail 706', '#d3a809', '#B27AB4', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR751': new Route('751', '輕鐵 751|Light Rail 751', '#d3a809', '#f5821f', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR751P': new Route('751P', '輕鐵 751P|Light Rail 751P', '#d3a809', '#000000', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true),
    'LR761P': new Route('761P', '輕鐵 761P|Light Rail 761P', '#d3a809', '#6f2b91', true, [], ["1", "10", "15", "20", "30", "40", "50", "60", "70", "75", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200", "212", "220", "230", "240", "250", "260", "265", "270", "275", "280", "295", "300", "310", "320", "330", "340", "350", "360", "370", "380", "390", "400", "425", "430", "435", "445", "448", "450", "455", "460", "468", "480", "490", "500", "510", "520", "530", "540", "550", "560", "570", "580", "590", "600", "920"], true)
}
...
const UIPreset = {
    "default": {
        title: "'Myriad Pro', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        arrivals: "'Myriad Pro', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        platformCircle: "'Myriad Pro', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        eta: "'Myriad Pro', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
    ...
    "EAL": {
        title: "'Myriad Pro', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        arrivals: "'Myriad Pro', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        platformCircle: "'Myriad Pro', 'DFLiSongHK', 'Noto Sans', 'Noto Serif TC'",
        eta: "'Myriad Pro', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        chinFontSpacing: "normal",
        titleWidth: 94,
        ETAWidth: 94,
    ...
    "TWL": {
        title: "'Myriad Pro Semibold', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        arrivals: "'Myriad Pro Semibold', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        platformCircle: "'Myriad Pro', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        eta: "'Myriad Pro', 'Noto Sans', 'DFLiSongHK', 'Noto Serif TC'",
        chinFontSpacing: "3rem",
        titleWidth: 93,
...
export { Route, Station, ArrivalEntry, RouteList, StationList, DisplayMode, UIPreset, PIDS_OVERRIDE_DATA, promotionData, getRoute, getStation };